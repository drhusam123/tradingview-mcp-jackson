...
CATALOG = {
    ...
    "layers": {
        ...
        "L2": ["pine_analytics", "tv_discovery_features", "closing_pressure_daily", "market_breadth_enhanced",
               ...
               "lre_daily_scores", "lre_research_feed_daily", "lre_shadow_signals_daily",
               "med_daily_scores", "med_research_feed", "med_analogue_scores_daily"],
    ...
    "miners": [
        ...
        "indicators_confluence_miner", "indicator_divergence_miner", "tv_microstructure",
        "breadth_regime_miner", "cross_market_miner", "dom_liquidity_miner", "outcome_weighted_quant",
        "bayesian_wr_miner", "counterfactual_atoms", "arbitration_veto_miner", "hypothesis_sandbox_bridge",
        ...
        "dmids_structural_miner", "egx_mde_miner", "egx_lre_miner", "egx_med_miner", "egx_x_pro_miner", "causal_discovery_miner",
    ...
    "json_artifacts": [
        ...
        "discovery_lre_manifest.json", "lre_research_feed_last.json",
        "discovery_med_manifest.json", "med_daily_chain_last.json", "med_research_feed_last.json",
        "med_0_3_discovery_report.json", "med_false_edge_feed_last.json", "med_discovery_atoms_last.json",
        "med_cognition_feed_last.json", "med_lessons_bridge_last.json", "med_0_3_calibrate_last.json",
        "mde_shadow_attribution_last.json", "mde_shadow_last.json", "mde_signal_provider_last.json",
        "egx_rules_runtime.json",
    ],
}
