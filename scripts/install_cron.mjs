...
const filtered = current.split('\n')
  ...
  .join('\n').trim();
const ALL_CRONS = [
  CRON_LINE, CRON_MACRO, CRON_TG, CRON_TV_LIVE_1, CRON_TV_LIVE_2, CRON_DMIDS, CRON_REGIME_SWEEP_W, CRON_HYP_BRIDGE_W, CRON_DISCOVERY_AUDIT, CRON_PERPETUAL_W, CRON_TV_MICRO, CRON_DHVD,
